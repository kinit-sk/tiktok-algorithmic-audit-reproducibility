...
USER_PROFILES = {
    36: {
        "HASHTAGS_TO_LIKE": [],
        "HASHTAGS_TO_FOLLOW": [],
        "WATCH_COEFFICIENT_WITH_HASHTAGS": 0.25,
        "WATCH_COEFFICIENT_NO_HASHTAGS": 0.25,
        ...
        "USERNAMES_TO_FOLLOW": [],
        "USERNAMES_TO_LIKE": [],
        "HASHTAGS_WATCH_LONGER": ["football", "food", "euro2024", "movie", "foodtiktok", "gaming", "film",
      "tiktokfood", "gta6","roblox", "gta", "minecraft", "marvel", "cat", "dog", "pet", "dogsoftiktok", "catsoftiktok", "cute",
      "puppy", "dogs", "cats", "animals", "petsoftiktok", "kitten"],
        "HASHTAGS_WATCH_LONGER_COEFFICIENT": 0.5,
    },
}
